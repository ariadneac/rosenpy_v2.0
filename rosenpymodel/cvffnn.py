...
class CVFFNN(rpnn.NeuralNetwork): 
    ...
    def _backprop_gpu(self, y, y_pred, epoch):
        ...
        for layer in reversed(self.layers):
            ...
            # Calculate deltaDir
            if deltaDir is not None:  # For layers other than the last one
            ...
            regl2 = self.xp.asarray(regFunc.l2_regularization(self.xp, layer.lambda_init, layer.reg_strength, epoch))
            ...
            # Update parameters using the optimizer's method
    ...
    def addLayer(self, neurons, ishape=0, weights_initializer=initFunc.random_normal, 
                 bias_initializer=initFunc.random_normal, activation=actFunc.tanh, 
                 reg_strength=0.0, lambda_init=0.1, lr_decay_method=decayFunc.none_decay,  
