...
# Create an instance of the CVRBF Neural Network
#nn.addLayer(ishape=input_data.shape[1], neurons=100, oshape=output_data.shape[1], gamma_rate=1e-2, sigma_rate=1e-2)
nn.addLayer(ishape=input_data.shape[1], neurons=20, oshape=20)
nn.addLayer(neurons=20, oshape=output_data.shape[1])
