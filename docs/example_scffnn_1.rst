...
.. code-block:: python
    :caption: example_scffnn_1.py
    :name: example_scffnn_1
	
	# Import module from RosenPy
	import rosenpymodel.scffnn as mynn
	...
	#nn.addLayer(ishape=input_data.shape[1], neurons=30, lr_decay_method=decayFunc.time_based_decay)
	#nn.addLayer(neurons=output_data.shape[1], lr_decay_method=decayFunc.time_based_decay)

	nn.addLayer(ishape=input_data.shape[1], neurons=30)
	nn.addLayer(neurons=output_data.shape[1])
