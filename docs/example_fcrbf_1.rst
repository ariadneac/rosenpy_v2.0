Code Example FCRBFNN
====================

.. code-block:: python
    :caption: example_fcrbf_1.py
    :name: example_fcrbf_1

	# Import module from RosenPy
	import rosenpymodel.fcrbfnn as mynn
	...
	# Create an instance of the FCRBF Neural Network
	nn.addLayer(ishape=input_data.shape[1], neurons=20, oshape=output_data.shape[1], gamma_rate=1e-3, sigma_rate=1e-3)
